...
@Entity
@Table(name="sc_generickey")
@IdClass(GenericKeyPk.class)
public class GenericKey implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3845106741764793379L;
	@NotEmpty
	...
	public GenericKey(String genericKey, String description) {
		super();
