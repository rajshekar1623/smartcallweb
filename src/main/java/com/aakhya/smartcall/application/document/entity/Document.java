...
public class Document implements Serializable {
	...
	private GenericClassifier documentIdDesc;
	...
	private String documentLevelStr;
	private GenericClassifier documentLevelDesc;
	private Long mandatory;
	private String mandatoryStr;
	private GenericClassifier mandatoryDesc;
	private Long attachementRequired;
	private String attachementRequiredStr;
	private GenericClassifier attachementRequiredDesc;
	private String fileName;
	private Long viewAllowed;
	private String viewAllowedStr;
	private GenericClassifier viewAllowedDesc;
	private Long collateralType;
	private String collateralTypeStr;
	private GenericClassifier collateralTypeDesc;
	...
	@Transient
	public GenericClassifier getDocumentIdDesc() {
		return documentIdDesc;
	}

	public void setDocumentIdDesc(GenericClassifier documentIdDesc) {
		if (null != documentIdDesc) {
			this.documentId = documentIdDesc.getGenericId();
		}
		this.documentIdDesc = documentIdDesc;
	}
	...
	public void setDocumentLevel(Long documentLevel) {
		this.documentLevel = documentLevel;
	}

	@Transient
	public String getDocumentLevelStr() {
		return documentLevelStr;
	}

	public void setDocumentLevelStr(String documentLevelStr) {
		this.documentLevelStr = documentLevelStr;
	}

	@Transient
	public GenericClassifier getDocumentLevelDesc() {
		return documentLevelDesc;
	}

	public void setDocumentLevelDesc(GenericClassifier documentLevelDesc) {
		if (null != documentLevelDesc) {
			this.documentLevel = documentLevelDesc.getGenericId();
			this.documentLevelStr = documentLevelDesc.getDescription();
		}
		this.documentLevelDesc = documentLevelDesc;
	}
	...
	@Transient
	public String getMandatoryStr() {
		return this.mandatoryStr;
	}

	public void setMandatoryStr(String mandatoryStr) {
		this.mandatoryStr = mandatoryStr;
	}

	@Transient
	public GenericClassifier getMandatoryDesc() {
		return this.mandatoryDesc;
	}

	public void setMandatoryDesc(GenericClassifier mandatoryDesc) {
		if (null != mandatoryDesc) {
			mandatory = mandatoryDesc.getGenericId();
		}
		this.mandatoryDesc = mandatoryDesc;
	}

	@Column(name = "attachementrequired")
	public Long getAttachementRequired() {
		return this.attachementRequired;
	}

	public void setAttachementRequired(Long attachementRequired) {
		this.attachementRequired = attachementRequired;
	}

	@Transient
	public String getAttachementRequiredStr() {
		return this.attachementRequiredStr;
	}

	public void setAttachementRequiredStr(String attachementRequiredStr) {
		this.attachementRequiredStr = attachementRequiredStr;
	}

	@Transient
	public GenericClassifier getAttachementRequiredDesc() {
		return this.attachementRequiredDesc;
	}

	public void setAttachementRequiredDesc(
			GenericClassifier attachementRequiredDesc) {
		if (null != attachementRequiredDesc) {
			this.attachementRequired = attachementRequiredDesc.getGenericId();
		}
		this.attachementRequiredDesc = attachementRequiredDesc;
	}
	...
	@Transient
	public String getViewAllowedStr() {
		return this.viewAllowedStr;
	}

	public void setViewAllowedStr(String viewAllowedStr) {
		this.viewAllowedStr = viewAllowedStr;
	}

	@Transient
	public GenericClassifier getViewAllowedDesc() {
		return this.viewAllowedDesc;
	}

	public void setViewAllowedDesc(GenericClassifier viewAllowedDesc) {
		if (null != viewAllowedDesc) {
			this.viewAllowed = viewAllowedDesc.getGenericId();
		}
		this.viewAllowedDesc = viewAllowedDesc;
	}
	...
	public String getCollateralTypeStr() {
		return collateralTypeStr;
	}

	public void setCollateralTypeStr(String collateralTypeStr) {
		this.collateralTypeStr = collateralTypeStr;
	}

	@Transient
	public GenericClassifier getCollateralTypeDesc() {
		return collateralTypeDesc;
	}

	public void setCollateralTypeDesc(GenericClassifier collateralTypeDesc) {
		if (null != collateralTypeDesc) {
			this.collateralType = collateralTypeDesc.getGenericId();
			this.collateralTypeStr = collateralTypeDesc.getDescription();
		}
	...
	@JoinColumns({
			...
			@JoinColumn(name = "documentchecklistcategory", referencedColumnName = "documentchecklistcategory", insertable = false, updatable = false),
			@JoinColumn(name = "documentcategorylevel", referencedColumnName = "documentcategorylevel", insertable = false, updatable = false),
	...
	public boolean equals(Object other) {
		if (other instanceof Document) {
			...
			try {
				final boolean areEqual = documentId
						.equals(otherDocument.documentId)
						&& documentChecklistId
								.equals(otherDocument.documentChecklistId)
						&& documentCategory.equals(otherDocument.documentCategory)
						&& companyId.equals(otherDocument.companyId);
				return areEqual;
			} catch (Exception e) {
	...
	public int hashCode() {
		if (null != documentId && null != documentChecklistId
				&& null != documentCategory && null != companyId)
			return documentId.hashCode() + documentChecklistId.hashCode()
					+ documentCategory.hashCode()+companyId.hashCode();
		else
			return 13;
	}
}