...
public class SecurityMainLayout extends AppLayout {
	...
	public SecurityMainLayout(SecurityService securityService,UserService userService) {
	...
	private void createDrawer() {
		RouterLink listLink = new RouterLink("User", UserView.class);
        listLink.setHighlightCondition(HighlightConditions.sameLocation());
        
        RouterLink genericKey = new RouterLink("Role", UserRoleView.class);
        
        VerticalLayout drawer = new VerticalLayout(listLink,genericKey);
        drawer.setSizeFull();
