...
public interface UserRepository extends JpaRepository<User, String> {
	...
	@Query("select c from User c " + " where c.branchCode = :branchCode and c.status <> 'X'")
	...
	@Query("select c from User c left outer join c.userRoles d " + " where d.roleId = :roleId and c.status <> 'X'")
