...
@Entity
@Table(name = "sc_integrationFileFormat")
@IdClass(IntegrationFileFormatDetailPk.class)
public class IntegrationFileFormatDetail implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7231136957561926080L;
	...
	private IntegrationMaster integrationMaster;
	...
	@ManyToOne
	@JoinColumns({
		@JoinColumn(name = "integrationid", referencedColumnName = "integrationid",insertable = false, updatable = false),
		@JoinColumn(name = "companyid", referencedColumnName = "companyid",insertable = false, updatable = false)
	})
	public IntegrationMaster getIntegrationMaster() {
		return integrationMaster;
	}

	public void setIntegrationMaster(IntegrationMaster integrationMaster) {
		this.integrationMaster = integrationMaster;
	}
}
